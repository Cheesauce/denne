...
const LINKEDIN_URL = 'https://www.linkedin.com/in/denne-joshua-s-865823201/';
          ...
          <div className="p-8 border-2 border-black dark:border-white bg-white dark:bg-gray-800 h-full brutal-shadow">
            ...
            <div className="space-y-4">
              <p className="flex items-center gap-2 dark:text-gray-400 text-gray-600">
                <MapPin className="w-5 h-5 text-[#10b981] shrink-0" strokeWidth={1.75} /> Pasig City, Philippines
              </p>
              <p className="flex items-center gap-2 dark:text-gray-400 text-gray-600">
                <Phone className="w-5 h-5 text-[#10b981] shrink-0" strokeWidth={1.75} /> 0976-477-9947
              </p>
              <p className="flex items-center gap-2 dark:text-gray-400 text-gray-600">
                <Mail className="w-5 h-5 text-[#10b981] shrink-0" strokeWidth={1.75} />
              ...
              <p className="flex items-center gap-2 dark:text-gray-400 text-gray-600">
                ...
                <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" className="hover:text-[#10b981] transition-colors">
                  linkedin.com/in/denne-joshua-s
                </a>
              </p>
            </div>
          </div>
