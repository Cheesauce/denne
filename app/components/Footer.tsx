...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-50 dark:bg-black border-t-2 border-black dark:border-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="font-mono text-xs uppercase tracking-widest mb-4 dark:text-white text-black">Quick Links</h4>
          ...
          <div>
            <h4 className="font-mono text-xs uppercase tracking-widest mb-4 dark:text-white text-black">Contact</h4>
        ...
        <div className="border-t-2 border-black dark:border-white mt-12 pt-8 text-center font-mono text-xs uppercase tracking-widest dark:text-gray-400 text-gray-600">
